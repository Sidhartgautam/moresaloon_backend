...
class SaloonDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Saloon
        fields = ['id','name','logo','short_description','long_description','address','banner','email','contact_no','website_link','facebook_link','instagram_link','reviews','lat','lng','is_open']
